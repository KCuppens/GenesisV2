...
class LengthValidator(object):
    ...
    def __init__(self, min_length=None, max_length=None):
        self.min_length = min_length or get_config('USERS_PASSWORD_MIN_LENGTH')
        self.max_length = max_length or get_config('USERS_PASSWORD_MAX_LENGTH')
...
class ComplexityValidator(object):
    ...
    def __init__(self):
        self.password_policy = get_config('USERS_PASSWORD_POLICY')

    def __call__(self, value):
        if not get_config('USERS_CHECK_PASSWORD_COMPLEXITY'):  # pragma: no cover
            return
...
class EmailDomainValidator(object):
    ...
    def __init__(self, ):
        self.domain_blacklist = get_config('USERS_EMAIL_DOMAINS_BLACKLIST')
        self.domain_whitelist = get_config('USERS_EMAIL_DOMAINS_WHITELIST')

    def __call__(self, value):
        if not get_config('USERS_VALIDATE_EMAIL_DOMAIN'):  # pragma: no cover
            return
