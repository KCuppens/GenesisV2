...
class AdminModel(models.Model):
    ...
    def create_history_record(sender, instance, **kwargs):
        apps = ['Site', 'PageBlockElement','User','DashboardConfiguration','Session','Migration','History','Icon','Configuration','TranslationEntry','Thumbnail','DetailPage', 'MessageLog', 'FormPage', 'FormElement', 'FormElementOption','FormResult','FormResultField', 'Email']
